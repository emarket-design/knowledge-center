...
function knowledge_center_show_optin() {
	...
	if (!get_option('knowledge_center_tracking_optin')) {
		...
		echo $tr_link . '</ul><div class="emd-permissions"><a href="#" class="emd-perm-trigger"><span class="dashicons dashicons-info" style="text-decoration:none;"></span>' . __('What permissions are being granted?', 'knowledge-center') . '</a><ul class="emd-permissions-list" style="display:none;">';
